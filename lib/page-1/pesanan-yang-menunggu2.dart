    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // autogrouptbcdU9f (5zYVkq7xYdSpxniWjuTBcD)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    // autogrouptf1bKRB (5zYVxpmyQi38QEqVgFtf1b)
                        ...
                        Container(
                          ...
                          child: TextButton(
                            ...
                            child: Container(
                              ...
                              height: 40*fem,
                              child: Image.asset(
                                'assets/page-1/images/multiply-kk1.png',
                                fit: BoxFit.contain,
                              ),
                            ),
                          ),
                  ...
                  Container(
                    ...
                    height: 20*fem,
                    child: Image.asset(
                      'assets/page-1/images/vector-Vxd.png',
                      width: 20*fem,
                      height: 20*fem,
                    ),
                  ),
                  ...
                  Container(
                    ...
                    height: 16*fem,
                    child: Image.asset(
                      'assets/page-1/images/vector-MFX.png',
                      width: 20*fem,
                      height: 16*fem,
                    ),
                  ),
            ...
            Container(
              // autogroup3cq1yvy (5zYXf7HYGBzeXQGV2K3cQ1)
              ...
              child: Column(
                ...
                children: [
                  Container(
                    // autogroupbkhwXBo (5zYW94yuK9i6P278EBbkHw)
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          // autogroupc3h33fw (5zYWK9XSeg9hAyV6w2C3H3)
                          width: 120*fem,
                          height: double.infinity,
                          decoration: BoxDecoration (
                        ...
                        Container(
                          // autogroup1cqq7fo (5zYWP9QnGhgTenrmF91CQq)
                          width: 120*fem,
                          height: double.infinity,
                          decoration: BoxDecoration (
                            border: Border.all(color: Color(0xff000000)),
                        ...
                        Container(
                          // autogroupnkhfzjb (5zYWTE8KBBpuj2BFUoNkhF)
                          width: 120*fem,
                          height: double.infinity,
                          decoration: BoxDecoration (
                            border: Border.all(color: Color(0xff000000)),
                  ...
                  Container(
                    // autogroup9tbfVgM (5zYWc938YHexDCKfG29Tbf)
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          // autogrouplb1styP (5zYWkDe14oLAmF1oooLB1s)
            ...
            Container(
              // autogroup3gjdFhT (5zYWvTqvyF18k2HSMj3GJD)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    // autogroups9soMkV (5zYX6siFSbuTudSikjs9so)
                  ...
                  Container(
                    // autogroupy6hfM8D (5zYXChssJiyFSXcZNpy6HF)
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          height: 33.33*fem,
                          child: Image.asset(
                            'assets/page-1/images/group-jNh.png',
                            width: 25*fem,
                            height: 33.33*fem,
                          ),
                        ),
                  ...
                  Container(
                    // autogroupbqvjuow (5zYXHsPvuB7aE8DncZbqVj)
                        ...
                        Positioned(
                          ...
                          child: Align(
                            child: SizedBox(
                              ...
                              height: 45*fem,
                              child: Image.asset(
                                'assets/page-1/images/online-support-6HF.png',
                                fit: BoxFit.contain,
                              ),
                            ),
                          ),
                  ...
                  Container(
                    // autogroupczndFmK (5zYXNHSEwVikg1KaYQCzNd)
                    height: double.infinity,
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Container(
                          ...
                          height: 40*fem,
                          child: Image.asset(
                            'assets/page-1/images/vector-BNR.png',
                            width: 40*fem,
                            height: 40*fem,
                          ),
                        ),
